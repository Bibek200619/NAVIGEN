...
describe('MissionHistory Component', () => {
  ...
  it('renders real mission list with names and statuses', () => {
    ...
    const mockMissions: Mission[] = [
      { id: 'hist-1', name: 'Area Scan Alpha', status: 'completed', createdAt: '2026-09-04T08:00:00Z', completedAt: '2026-09-04T08:30:00Z' },
      { id: 'hist-2', name: 'Waypoint Run Bravo', status: 'failed', createdAt: '2026-09-04T09:00:00Z', completedAt: '2026-09-04T09:10:00Z', failureReason: 'Wheel traction slip detected' },
    ];

    render(<MissionHistory missions={mockMissions} onSelectMission={onSelect} selectedMissionId="hist-1" />);
